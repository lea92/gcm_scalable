...
public class MainADLNOMAPE extends MainCommun{
	...
	public static void runwithoutunomic(String[] args) throws Exception {
		...
		Component composite = (Component) fac.newAutonomicComponent(adl,context
				);
		...
		Utils.getPAMulticastController(master).unbindGCMMulticast("i1", "i1");		
		Utils.getPABindingController(master).bindFc("itf1",slave.getFcInterface("i1"));
